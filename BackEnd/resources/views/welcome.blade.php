...
<body>
    ...
    <section id="ourService">
        ...
        <div class="d-flex justify-content-center">
            <a href="allcars.html" class="card mt-1 mb-5 border border-info" style="width: 20rem; background-color: #0B0C10; text-decoration: none;">
                <div class="card-body">
    ...
    <section id="partners">
        <div>
            <img src="assets/img/partners.png" alt="" width="100%">
        </div>
    </section>

    <div class="container-fluid " style="background-color: #12232E;">
        <footer class="py-3">
          ...
          <p class="text-center text-white">© 2022 QuickDrive, All Rights reserved</p>
        </footer>
    </div>
